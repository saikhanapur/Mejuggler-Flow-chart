...
class ActionableIntelligenceService:
    ...
    async def _extract_flow_structure(
        ...
        - Larger documents may have incomplete extraction
        """
        ...
        if doc_length > 20000:
            logger.warning(
                ...
                f"   Document may be truncated for gateway compatibility."
            )
        ...
        if doc_length > 100000:
            logger.error(
                ...
                f"   Results will likely be incomplete. Please split document."
            )
